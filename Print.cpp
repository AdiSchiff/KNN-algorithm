...
//
//    auto * dis = new Distance();
//    printDistance(dis->euclideanDistance(v1,v2));
//    printDistance(dis->manhattanDistance(v1,v2));
//    printDistance(dis->chebyshevDistance(v1,v2));
//    printDistance(dis->canberraDistance(v1,v2));
//    printDistance(dis->minkowskiDistance(v1,v2,2));
//}
